import { FomoContent, FomoItem } from "@/lib/types";
...
type Props = {
  content: FomoContent;
  onChange: (content: FomoContent) => void;
};

export default function FomoEditor({ content, onChange }: Props) {
  ...
  function addItem() {
    const newItem: FomoItem = { id: Date.now().toString(), text: "New urgency point" };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <Label className="text-zinc-300 text-xs">Urgency Points</Label>
